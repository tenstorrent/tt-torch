...
class install_metal_libs(install_lib):
    def run(self):
        ...
        lib_dir = os.path.abspath(os.path.join(os.getcwd(), "_skbuild", "linux-x86_64-3.11", "cmake-install", "lib"))
        ...
        metal_dir = os.path.abspath(os.path.join(os.getcwd(), "third_party", "tt-mlir", "src", "tt-mlir", "third_party", "tt-metal", "src", "tt-metal"))
        ...
        install_path = os.path.join(os.path.join(self.install_dir, "tt_torch"), "tt_metal")
        os.makedirs(install_path, exist_ok=True)
