...
// preprocess_inputs(tt::runtime::Device device, std::vector<at::Tensor>
// &inputs,
...
//                             tt::runtime::Binary &binary, uint32_t
//                             program_idx, std::vector<tt::runtime::Tensor>
//                             &rt_inputs) {
...
//   std::vector<at::Tensor> outputs = run(device, binary, program_idx,
//   rt_inputs);
...
PYBIND11_MODULE(tt_mlir, m) {
  ...
  //       .def(py::init<>())
  //       .def_readwrite("mesh_offset",
  //       &tt::runtime::MeshDeviceOptions::meshOffset)
  //       .def_readwrite("device_ids",
  //       &tt::runtime::MeshDeviceOptions::deviceIds)
  //       .def_readwrite("num_hw_cqs",
  //       &tt::runtime::MeshDeviceOptions::numHWCQs)
  //       .def_readwrite("enable_program_cache",
  //                      &tt::runtime::MeshDeviceOptions::enableProgramCache)
  //       .def_property(
  //           "l1_small_size",
  //           [](const tt::runtime::MeshDeviceOptions &o) {
  //             return o.l1SmallSize.has_value() ?
  //             py::cast(o.l1SmallSize.value())
  //                                              : py::none();
  //           },
  ...
  //         py::arg("sub_mesh"), "Release the sub-mesh device using the new
  //         API");
  //   m.def("deallocate_tensor", &tt::runtime::deallocateTensor,
  //   py::arg("tensor"),
