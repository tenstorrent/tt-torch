...
class ThisTester(ModelTester):
    def _load_model(self):
        ...
        self.tokenizer_2 = T5Tokenizer.from_pretrained("google/t5-v1_1-xxl", torch_dtype=torch.bfloat16)
        self.text_encoder_2 = T5EncoderModel.from_pretrained("google/t5-v1_1-xxl", torch_dtype=torch.bfloat16)
        self.tokenizer = CLIPTokenizer.from_pretrained("openai/clip-vit-large-patch14", torch_dtype=torch.bfloat16)
        self.text_encoder = CLIPTextModel.from_pretrained("openai/clip-vit-large-patch14", torch_dtype=torch.bfloat16)
        return pipe
    ...
    def _load_inputs(self):
        ...
        pooled_prompt_embeds = self.text_encoder(text_inputs.input_ids, output_hidden_states=False)
