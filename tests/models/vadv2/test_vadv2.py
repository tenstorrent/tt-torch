...
from third_party.tt_forge_models.vadv2.pytorch.loader import ModelLoader
...
def test_vadv2(record_property, model_info, mode, op_by_op):
    ...
    skip_full_eval_test(
        ...
        reason="Out of Memory: Not enough space to allocate 62179328 B L1 buffer across 64 banks, where each bank needs to store 971552 B",
