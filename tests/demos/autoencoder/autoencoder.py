...
def test_encoder_linear_two():
    ...
    verify_module(EncoderLinearTwo(), input_shapes=[(1, 128)])
...
def test_encoder_linear_three():
    ...
    verify_module(EncoderLinearThree(), input_shapes=[(1, 64)])
...
def test_encoder_linear_four():
    ...
    verify_module(EncoderLinearFour(), input_shapes=[(1, 12)])
...
def test_decoder_linear_one():
    ...
    verify_module(DecoderLinearOne(), input_shapes=[(1, 3)])
...
def test_decoder_linear_two():
    ...
    verify_module(DecoderLinearTwo(), input_shapes=[(1, 12)])
...
def test_decoder_linear_three():
    ...
    verify_module(DecoderLinearThree(), input_shapes=[(1, 64)])
...
def test_decoder_linear_four():
    ...
    verify_module(DecoderLinearFour(), input_shapes=[(1, 128)])
...
def test_relu():
    ...
    verify_module(Relu(), input_shapes=[(1, 12)])
    verify_module(Relu(), input_shapes=[(1, 64)])
    verify_module(Relu(), input_shapes=[(1, 128)])
